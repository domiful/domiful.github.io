    ...
    <div className="section">
      <Element name="about">
        ...
        <span className="litems">
          <AboutItem
            title="Philosophy"
            info="I actually don’t really believe in having a philosophy. It constrains your thinking and can be detrimental to any process. Everything cannot be minimal, but everything should be understandable. <br /><br />I guess that might be a philosophy."
          ...
          <Element name="resume">
            <AboutItem
              title="Resum&eacute;"
              info="You shouldn't leave empty handed, please take a copy of my resume. <br /><br />Also feel free to drop me an email or DM on LinkedIn!"
              section={props.section}
              imgs={[res]}
              link="https://www.dropbox.com/scl/fi/4thkhj1w14s0hkbi1ydyp/resume24b.pdf?rlkey=cbq870e9xlvsxr1qs97xktr5w&dl=0"
            />
          </Element>
        </span>
      </Element>
    ...
    <div className="section">
      <Element name="contact">
        ...
        <span className="litems">
          <ContactItem
            title="Contact"
            info="This is where a info is going fmi."
          />
        </span>
      </Element>
    </div>
